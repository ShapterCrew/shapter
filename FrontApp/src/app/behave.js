      ...
      behave.ui = function(options) {
        if (options.method == 'dialog') {
          return {
            ...
            compile: function() {
              return "<div>"+ "  <div class=\"bh-dialog-backdrop fade\"></div>"+ "  <div style=\"text-align:center\" class=\"bh-well bh-dialog\">"+ "    <div class=\"bh-legend\" style=\"text-align:center\">" + options.badge.name + "</div>"+ "    <div>"+ "      <img style=\"margin:auto;display:block\" "+ "           src=\""+ options.badge.icon + "\" "+ "           width=\"140px\" "+ "           height=\"140px\" />"+ "    </div>"+ "    <br>"+ "    <p>" + "      " + options.badge.message + "    </p>"+ "    <hr>"+ (this.facebookEnabled ? "<div class=\"bh-btn bh-btn-facebook\" ng-click=\"shareOnFacebook()\"><i class=\"icon-facebook\"></i> | Share</div>" : "")+ "    <div class=\"bh-btn\" ng-click=\"close()\">" + (this.facebookEnabled ? 'Or close' : 'close') + "</div>"+ "  </div>"+ "</div>";
            },
