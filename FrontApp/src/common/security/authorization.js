...
.provider('securityAuthorization', {
  ...
  requireConfirmedUser: ['securityAuthorization', function(securityAuthorization) {
    return securityAuthorization.requireConfirmedUser();
  }],

  requireConfirmedStudent: ['securityAuthorization', function(securityAuthorization) {
    return securityAuthorization.requireConfirmedStudent();
  }],
  ...
  $get: ['security', 'securityRetryQueue', function(security, queue) {
    var service = {
      ...
      requireConfirmedStudent: function() {
        var promise = security.requestCurrentUser().then(function(userInfo) {
