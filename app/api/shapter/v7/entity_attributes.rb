    ...
    class EntityAttributes < Grape::API
      ...
      namespace :entity_attributes do 
        ...
        get do 
          ...
          present :user, [:image,:lang, :firstname, :lastname, :schools, :admin, :confirmed, :confirmed_student, :comments, :comments_likes_count, :comments_dislikes_count, :user_diagram, :sign_in_count, :provider, :is_fb_friend, :comments_count, :items_count, :diagrams_count, :skills].sort
